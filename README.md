...
- Learn through its interactive tutorials: training.play-with-docker.com.
- Give presentations at conferences and meetups.
- Allow running advanced workshops that’d usually require complex setups
